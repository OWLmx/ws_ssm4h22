...
class EventDataModule(LightningDataModule):
    ...
    task_text_field_map = {
        "base": ["text"],
        "text_and_pos": ["text", "ith_pos"],
        "text_and_pos10": ["text", "i10th_pos"],
        "text_and_pos5": ["text", "i5th_pos"],
        "text_extrafeat_pos10": ["text"],
        "text_and_verb": ["text", "verb"],
        "text_and_verb-quant": ["text", ["verb", "quants"]],
        "text_and_verb-term-quant": ["text", ["verb", "term", "quants"]],
    }

    task_label_field_map = {
        "base": ["event"],
        "text_and_pos": ["event"],
        "text_and_pos10": ["event"],
        "text_and_pos5": ["event"],
        "text_extrafeat_pos10": ["event"],
        "text_and_verb": ["event"],
        "text_and_verb-quant": ["event"],
        "text_and_verb-term-quant": ["event"],
    }    
    ...
    task_num_labels = {
        "base": 3, # Disposition, NoDisposition, Undetermined
        "text_and_pos": 3, # Disposition, NoDisposition, Undetermined
        "text_and_pos10": 3, # Disposition, NoDisposition, Undetermined
        "text_and_pos5": 3, # Disposition, NoDisposition, Undetermined
        "text_extrafeat_pos10": 3,
        "text_and_verb":3,
        "text_and_verb-quant": 3,
        "text_and_verb-quant": 3,
        "text_and_verb-term-quant": 3
    }
    ...
    def __init__(
        ...
        **kwargs,
        ...
        if kwargs.get("label_encoder", None):
